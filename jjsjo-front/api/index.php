...
<body>
  ...
  <div class="container">
    ...
    <div class="section">
      ...
      <?php foreach ($currencies as $currency): ?>
        <tr>
          <td><?php echo $currency['curID']; ?></td>
          <td><?php echo $currency['curName']; ?></td>
          <td><?php echo $currency['curBuyRate']; ?></td>
          <td><?php echo $currency['curSellRate']; ?></td>
        </tr>
      <?php endforeach; ?>
    </tbody>
        </table>
  ...
  <div class="copy">
    <div class="cp">Copyright Design © JJSJO 2023. All right reserved <br> Powered By <a href="https://petra-ms.com/">Petra MS</a></div>
  </div>
  <!-- end footer -->
